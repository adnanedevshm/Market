  ...
  try {
    ...
    if (!PAYPAL_CLIENT_ID) {
      ...
      return res.status(500).json({
        ...
        details: "Add VITE_PAYPAL_CLIENT_ID to environment",
      });
    }
    ...
    if (!PAYPAL_CLIENT_SECRET) {
      ...
      return res.status(500).json({
        ...
        details: "Add PAYPAL_CLIENT_SECRET to environment",
      });
    }
    ...
    if (!accessToken) {
      return res.status(500).json({
        ...
        hint: "Check PAYPAL_CLIENT_ID and PAYPAL_CLIENT_SECRET in environment",
      });
    }
